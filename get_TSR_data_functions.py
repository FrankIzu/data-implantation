...
class TSR_data_functions:
    ...
    def get_TSR_by_Class(self, class_size, colname, nfeatures): 
        df = pd.read_csv("datasets/SPOTRIAS_organized_03May2022.csv").drop(['HOSP_MRS90_DATE'], axis=1)
       
        target_label = 'HOSP_MRS90' # HOSP_MRSDIS HOSP_MRS90
        ...
        #print(df.dtypes)
        df.to_csv('datasets/SPOTRIAS_organized_03May2022_clean.csv', index=False)  
        ...
        if colname == 'NoTarget':              
            ...
            data_test.to_csv('datasets/SPOTRIAS_organized_03May2022_testset.csv', index=False) 
            ...
            pd.DataFrame(cols).to_csv(working_dir + colname + '/'  + 'features' + ".csv", header=['feature'], index=None)   
